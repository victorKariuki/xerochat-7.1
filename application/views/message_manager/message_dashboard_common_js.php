<script>
  ...
  $("document").ready(function(){
    ...
    $(document).on('click','.open_conversation',function(){
      ...
      var last_message_id  =  $(".card-body .chat-item:last-child .chat-details").attr('message_id');
    ...
    $(document).on('click','#final_reply_button',function(e){
      ...
      $.ajax({
          ...
          type:'POST',
          data:{page_table_id:page_table_id,reply_message:reply_message,from_user_id:from_user_id},
          success:function(response){
            $("#conversation_modal_body").append(response);
