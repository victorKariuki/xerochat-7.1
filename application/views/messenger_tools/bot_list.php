      ...
      <div class="card main_card">
        <div class="card-header">
          <div class="col-6 padding-0">
            <h4><i class="fas fa-newspaper"></i> <?php if($media_type =='ig') echo $this->lang->line("Accounts"); else echo $this->lang->line("Pages"); ?></h4>
          </div>
          <div class="col-6 padding-0">            
        ...
        <div class="card-header padding-left-10 padding-right-10">
          ...
          <div class="col-4 padding-0">
            ...
            <ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="width: 250px;">
              ...
              <li><a class="dropdown-item has-icon" table_id="" href="<?php echo base_url('messenger_bot/saved_templates'); ?>"><i class="fas fa-file-import"></i> <?php echo $this->lang->line("Import bot settings");?></a></li>
              <?php endif; ?>

              <?php if($this->session->userdata('user_type') == 'Admin' || in_array(315,$this->module_access)) : ?>
              <li><a class="dropdown-item has-icon visual_flow_campaigns" href="#"><i class="fas fa-project-diagram"></i> <?php echo $this->lang->line("Visual Flow Campaigns");?></a></li>
              <?php endif; ?>
           </ul>
          </div>
          <?php endif; ?>
