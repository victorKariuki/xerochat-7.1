...
class Update_system extends Home
{
	...
	public function update_list_v2()
	{
		...
		// Add On Information
		$count_data = $this->basic->count_row('add_ons',array('where'=>array('project_id !='=>19)));
		$config = array();
		...
		$add_ons = $this->basic->get_data('add_ons',array('where'=>array('project_id !='=>19)),'','',$config["per_page"],$page);
