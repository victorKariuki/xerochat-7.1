...
public function change_payment_status()
{
  ...
  {      
    ...
    $replace_variables = array("store_name"=>$store_name,"store_url"=>$store_url,"order_no"=>$order_no,"order_status"=>$payment_status,"invoice_url"=>$invoice_url,"update_note"=>$status_changed_note,"first_name"=>$first_name,"last_name"=>$last_name,"my_orders_url"=>$my_orders_url); 
