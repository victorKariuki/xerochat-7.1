...
class Messenger_bot extends Home
{
    ...
    public function send_message_bot_reply($value,$sender_id,$subscriber_info,$page_id,$user_reference_id="",$answer="",$fb_message_id="",$message_type=""){
        ...
        $social_media_type=$subscriber_info[0]['social_media'];
        ...
        foreach($message_array as $msg)
        {
            ...
            if((isset($subscriber_info[0]['status']) && $subscriber_info[0]['status']=="1") || $user_LEAD_FULL_NAMEreference_id!="")
            {
                // typing on and typing on delay [alamin]
    ...
    public function webhook_callback_main()
    {
      ...
      // $response_raw='{"object":"instagram","entry":[{"time":1628330312989,"id":"17841448207671144","messaging":[{"sender":{"id":"6071994329507855"},"recipient":{"id":"17841448207671144"},"timestamp":1628330312390,"message":{"mid":"aWdfZAG1faXRlbToxOklHTWVzc2FnZAUlEOjE3ODQxNDQ4MjA3NjcxMTQ0OjM0MDI4MjM2Njg0MTcxMDMwMDk0OTEyODE5MTg2NzE3MzAxMjUxNzozMDAzNzM5MjU0MDEzMTk2NDE4NDc2MDUwMjE1NjUyNTU2OAZDZD","attachments":[{"type":"story_mention","payload":{"url":"https:\/\/lookaside.fbsbx.com\/ig_messaging_cdn\/?asset_id=17943302464526599&signature=AbwwaSxD2tZHNv-_CrlIMy6LIdfjti8d9zUCLVpeiAkmoCNg41as249HF4yoDMci9r3zAVGi7SVs7yi4sCXqSLFycOcJjFGSvpOF1Pf_juUi2omUyCzyE87-HOipgh7xgoTFOdybdcIpyemSDxEiLVdQuVtVZEW6jOD1JH5pAdomWVUFQQ"}}]}}]}]}';
